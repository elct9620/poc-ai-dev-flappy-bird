...
| [BackgroundSystem](./design/system/background_system.md)   | Manages background entities for visual context.                     |
| [CollisionSystem](./design/system/collision_system.md)     | Detects collisions and triggers game-over logic.                    |
