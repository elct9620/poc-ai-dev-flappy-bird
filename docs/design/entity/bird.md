...
| animationFrame| number                | Current animation frame index (0-2 for wing flapping)           |
...
Increments the animation frame index to cycle through wing flapping sprites (0 → 1 → 2 → 0).
